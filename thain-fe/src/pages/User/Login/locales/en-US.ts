 ...
 */
export default {
  'user-login.login.userId': 'userId',
  ...
  'user-login.userId.required': 'Please enter your userId!',
  ...
  'user-login.client.placeholder':
    'Please describe your customer service, internal customers directly @ Name / flow number',
  'user-login.invites.label': 'Inviting critics',
  'user-login.invites.placeholder':
    'Please direct @ Name / flow number, you can invite up to 5 people',
